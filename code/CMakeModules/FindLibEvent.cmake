...
SET(LIBRARY_EVENTCORE_NAME_RELEASE libevent event)
SET(LIBRARY_EVENTCORE_NAME_DEBUG libevent event)

FIND_LIBRARY(LIBEVENT_LIBRARY_RELEASE
  NAMES ${LIBRARY_EVENTCORE_NAME_RELEASE}
  PATHS
...
FIND_LIBRARY(LIBEVENT_LIBRARY_DEBUG
  NAMES ${LIBRARY_EVENTCORE_NAME_DEBUG}
  PATHS
  $ENV{LIBEVENT_DIR}/lib
  /usr/local/lib
  /usr/lib
...
#   libevent_openssl
SET(LIBEVENT_OPENSSL_NAME_LIBRARY libevent_openssl event_openssl)
FIND_LIBRARY(LIBEVENT_OPENSSL_LIBRARY
  NAMES ${LIBEVENT_OPENSSL_NAME_LIBRARY}
  PATHS
  $ENV{LIBEVENT_DIR}/lib
  /usr/local/lib
  /usr/lib
...
#   libevent_pthreads
SET(LIBEVENT_PTHREADS_NAME_LIBRARY libevent_pthreads event_pthreads)
FIND_LIBRARY(LIBEVENT_PTHREADS_LIBRARY
  NAMES ${LIBEVENT_PTHREADS_NAME_LIBRARY}
  PATHS
  $ENV{LIBEVENT_DIR}/lib
  /usr/local/lib
  /usr/lib
...
MESSAGE(STATUS "LIBEVENT_PTHREADS_LIBRARY: ${LIBEVENT_PTHREADS_LIBRARY}  ")
