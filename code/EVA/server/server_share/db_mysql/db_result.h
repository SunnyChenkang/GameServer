...
public:
    ...
    //      int8
    sint8   GetInt8  ( size_t sz ) { return GetFieldParam<sint8>( sz );  }
    //      uint8;
    uint8   GetUint8 ( size_t sz ) { return GetFieldParam<uint8>( sz );  }
    //      int16;
    sint16  GetInt16 ( size_t sz ) { return GetFieldParam<sint16>( sz ); }
    //      uint16;
    uint16  GetUint16( size_t sz ) { return GetFieldParam<uint16>( sz ); }
    //      int32;
    sint32  GetInt32 ( size_t sz ) { return GetFieldParam<sint32>( sz ); }
    //      uint32;
    uint32  GetUint32( size_t sz ) { return GetFieldParam<uint32>( sz ); }
    //      int64;
    sint64  GetInt64 ( size_t sz ) { return GetFieldParam<sint64>( sz ); }
    //      uint64;
