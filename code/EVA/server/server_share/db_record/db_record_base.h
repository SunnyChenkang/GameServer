...
public:
    ...
    //   插入标记;
    void SetInsert ( void )     { m_DBState.setEnumValue( DB_EVENT_INSERT ); }
    //   更新标记;
    void SetUpdate ( void )     { m_DBState.setEnumValue( DB_EVENT_DELETE ); }
    //   删除标记;
    void SetDelete ( void )     { m_DBState.setEnumValue( DB_EVENT_DELETE ); }
