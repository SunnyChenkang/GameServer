...
public:
    ...
    */
    ...
    /****************************************<< LIST操作 >>****************************************/
    sint32 PushRedisList( const char* pRedisKey , sint32 RedisKeyLen , const char* pRedisValue , sint32 RedisValueLen );
    sint32 PoPRedisList ( const char* pRedisKey , sint32 RedisKeyLen , char* pRedisValue , sint32 RedisValueLen );
