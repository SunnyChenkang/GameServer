...
sint32 CDBRedis::PushRedisList( const char* pRedisKey , sint32 RedisKeyLen , const char* pRedisValue , sint32 RedisValueLen )
{
    redisReply* pRedis = NULL;
    pRedis = ( redisReply* )Command("LPUSH %b %b" , pRedisKey , (size_t)RedisKeyLen , pRedisValue , RedisValueLen );
...
sint32 CDBRedis::PoPRedisList( const char* pRedisKey , sint32 RedisKeyLen , char* pRedisValue , sint32 RedisValueLen )
{
    redisReply* pRedis = NULL;
