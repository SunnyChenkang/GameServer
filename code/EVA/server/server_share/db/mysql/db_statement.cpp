...
void SS::CDBStatement::SetSInt8( size_t sz , sint8 i8 )
{
    DBStatementInfo& ParamStmt = m_Param[ sz ];
...
void SS::CDBStatement::SetSInt16( size_t sz , sint16 i16 )
{
    DBStatementInfo& ParamStmt = m_Param[ sz ];
...
void SS::CDBStatement::SetSInt32( size_t sz , sint32 i32 )
{
...
void SS::CDBStatement::SetSInt64( size_t sz , sint64 i64 )
{
    DBStatementInfo& ParamStmt = m_Param[ sz ];
...
void SS::CDBStatement::Bind( size_t Count )
{
    ...
    for ( size_t idx = 0; idx < Count; idx++ )
    {
        ...
        m_Bind[idx].buffer_type     = (enum_field_types)ParamStmt.Field;
