...
#define LOG_CREATE      CRUDPSingleton<BaseLogManager>::instance
#define LOG_INSTANCE    CRUDPSingleton<BaseLogManager>::instance
#define LOG_DESTROY     CRUDPSingleton<BaseLogManager>::destroy
...
{\
    ...
    ostringstream strm; \
    strm << "[" << get_file_name(__FILE__) << ":" << __LINE__ << "] " << arg << std::endl; \
    __android_log_print(ANDROID_LOG_DEBUG ,"RUDP", strm.str().c_str() ); \
}\
