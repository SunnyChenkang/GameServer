// 定义RUDP的调用接口，实现socket、bind、connect、send、recv等函数接口;
...
public:
    ...
    RUDPEventHandler*   get_socket_event( int32_t rudp_id );
...
#define CREATE_RUDP         CRUDPSingleton< RUDPObject >::instance
#define RUDP                CRUDPSingleton< RUDPObject >::instance
#define DESTROY_RUDP        CRUDPSingleton< RUDPObject >::destroy
