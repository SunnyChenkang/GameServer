// 定义RUDP SOCKET对象，实现RUDP的连接、状态转换、链路异常检测等等;
...
protected:
    ...
    void                cancel_keeplive_timer( void );
    ...
    void                process_exist_keeplive( BinStream& strm , const Inet_Addr& remote_addr );
    void                process_exist_keeplive2( BinStream& strm , const Inet_Addr& remote_addr );
