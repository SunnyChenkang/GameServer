...
NL_STRING_CONVERSION_TABLE_ENTRY( FORMAT_PID )
NL_STRING_CONVERSION_TABLE_ENTRY( FORMAT_UID )
NL_END_STRING_CONVERSION_TABLE  ( EFormatKind, FormatConversion , FORMAT_INVALID )
