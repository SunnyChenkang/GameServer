...
public:
    ...
    double  Eval( NLMISC::CSString expression, double param0, double param1 , double param2 , double param3 , double param4 , double param5 , double param6 );
    ...
    double  Formula( NLMISC::CSString formula, double param );
